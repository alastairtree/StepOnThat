...
namespace StepOnThat
{
    public static class PropertyParser
    {
        public static Property Get(string pairString)
        {
            ...
            if(splits.Length > 2 || splits.Length < 1) throw new ApplicationException(String.Format("Unable to parse '{0}' into a key and value pair. Ensure syntax is 'key=value'",pairString));
